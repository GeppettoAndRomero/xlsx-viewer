...
const CACHE_NAME = 'xlsx-viewer-v1';
const RUNTIME_CACHE = 'xlsx-viewer-runtime';

// キャッシュするリソース（静的アセット）
const PRECACHE_URLS = [
  '/xlsx-viewer/',
  '/xlsx-viewer/manifest.json',
  '/xlsx-viewer/icon-192.png',
  '/xlsx-viewer/icon-512.png',
];
...
function isStaticAsset(pathname) {
  ...
  return staticExtensions.some(ext => pathname.endsWith(ext)) || pathname === '/xlsx-viewer/manifest.json';
}
