...
export const ui = {
  en: {
    ...
    dzDropSub: 'XLSX, XLSM, and XLS workbooks can be opened',
  ...
  ja: {
    ...
    dzDropTitle: 'ドロップで変換',
    dzDropSub: 'XLSX・XLSM・XLS ブックを開けます',
  ...
  zh: {
    ...
    dzPleaseWait: '请稍候',
    dzDropTitle: '拖放即可转换',
    dzDropSub: '可以打开 XLSX、XLSM 和 XLS 工作簿',
  ...
  de: {
    ...
    dzDropSub: 'XLSX-, XLSM- und XLS-Arbeitsmappen können geöffnet werden',
  ...
  es: {
    ...
    dzDropSub: 'Se pueden abrir libros XLSX, XLSM y XLS',
