...
export async function registerServiceWorker(): Promise<ServiceWorkerRegistration | null> {
  ...
  try {
    // Service Workerを登録（/xlsx-viewer/sw.js, scope=/xlsx-viewer/）。
    // scope がツールの全 locale ページ（/xlsx-viewer/, /xlsx-viewer/ja/ …）を被覆する。
    const registration = await navigator.serviceWorker.register('/xlsx-viewer/sw.js', {
      scope: '/xlsx-viewer/',
    });
